        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Sistema completo de agendamento e gestão predial
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                ...
                <p className="text-blue-600 text-sm">Meus agendamentos</p>
              </div>
              
              <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                <div className="text-3xl mb-3">👥</div>
                <h3 className="font-semibold text-green-800 mb-2">Perfil</h3>
                <p className="text-green-600 text-sm">Meus dados</p>
              </div>
              
              <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
                <div className="text-3xl mb-3">📊</div>
                <h3 className="font-semibold text-purple-800 mb-2">Relatórios</h3>
                <p className="text-purple-600 text-sm">Meus históricos</p>
              </div>
            </div>
          </div>
        </div>
